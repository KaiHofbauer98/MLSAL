...
/**
 * The LadderField contains its connected field information in the
 * LadderFieldNumber. When a ball is placed on a LadderField it will be moved to
 * the Field with the LadderFieldNumber.
 *
 * @author Kai Hofbauer
 */
public class LadderField extends Field {
     ...
     */
    private final int LadderFieldNumber;

    /**
     * The information should be stored during the construction.
     *
     * @param LadderFieldNumber
     * @param FiledNumber
     */
    public LadderField(int LadderFieldNumber, int FiledNumber) {
        super(FiledNumber);
        this.LadderFieldNumber = LadderFieldNumber;
    }
     ...
     */
    public int getLadderFieldNumber() {
        return LadderFieldNumber;
    }
